...
namespace pvr
{
    ...
    uint32_t PVRTDecompressPVRTC(const void* compressedData, uint32_t do2bitMode,
                                 uint32_t xDim, uint32_t yDim, uint8_t* outResultImage);
    ...
    uint32_t PVRTDecompressETC(const void* srcData, uint32_t xDim, uint32_t yDim,
                               void* dstData, uint32_t mode);
